...
Calculator.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Local::App::Calculator\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Local-App-Calculator\" VERSION=\"1\">" > Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT></ABSTRACT>" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR></AUTHOR>" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.24\" />" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> Local-App-Calculator.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> Local-App-Calculator.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  ...
	  lib/tokenize.pl blib\lib\tokenize.pl 
